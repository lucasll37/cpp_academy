...
# Imagem
./dist/bin/yolo ./src/yolo/models/yolov10n.onnx sua_imagem.jpg

# Webcam
./dist/bin/yolo ./src/yolo/models/yolov10n.onnx 0

# Benchmark (100 inferências, mede latência p50/p95/p99)
./dist/bin/yolo ./src/yolo/models/yolov10n.onnx sua_imagem.jpg --bench